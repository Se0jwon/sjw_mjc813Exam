...
public class TestMasterIReferTypeCasting {
    ...
    public void referDto2Entity() {
        ...
        entity.getMaster().setId(4678L);
        AssertionsForClassTypes.assertThat(entity.getMaster().getId()).isEqualTo(4678L);
        AssertionsForClassTypes.assertThat(entity.getMasterTableId()).isEqualTo(4678L);

        entity.setMasterTableId(5791L);
        AssertionsForClassTypes.assertThat(entity.getMasterTableId()).isEqualTo(5791L);
        AssertionsForClassTypes.assertThat(entity.getMaster().getId()).isEqualTo(5791L);
    }
    ...
    public void referEntity2Dto() {
        ...
        dto.setMasterTableId(3691L);
        AssertionsForClassTypes.assertThat(dto.getMasterTableId()).isEqualTo(3691L);
        AssertionsForClassTypes.assertThat(dto.getMaster().getId()).isEqualTo(3691L);

        dto.getMaster().setId(8642L);
        AssertionsForClassTypes.assertThat(dto.getMaster().getId()).isEqualTo(8642L);
        AssertionsForClassTypes.assertThat(dto.getMasterTableId()).isEqualTo(8642L);
    }
}
